...
export default function PublicMachine() {
  ...
  useEffect(() => {
    ...
    getMachineBySlug(params.slug)
      .then((data) => setMachine(data as PublicMachineData))
      .catch(() => {
        setError("Conteúdo não encontrado ou ainda não publicado.");
      });
  }, [params?.slug]);
  ...
  async function handleSuggestionSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      await createSuggestion({
        ...
        userContact: suggestionForm.userContact,
      });
    ...
    return (
      <main className="detail-page">
        <div className="container">
          <h1>{error}</h1>
          <Link href="/">Voltar para o MecLibras</Link>
        </div>
      </main>
    );
  }
  ...
  return (
    <main className="detail-page public-machine-page">
      <div className="container">
        ...
        {machine.video_url ? (
          <video
            className="machine-video-real public-video"
            controls
            playsInline
          ...
          <div className="video-placeholder">
            Vídeo em Libras ainda não cadastrado.
          </div>
        )}

        {machine.subtitle_url && (
          <p>
            <a href={machine.subtitle_url} target="_blank" rel="noreferrer">
              Abrir legenda
            </a>
          </p>
        )}
        ...
        {steps.length > 0 && (
          <section className="public-instructions">
            <h2>Orientações</h2>
        ...
        <section className="suggestion-section">
          ...
          <p>
            Encontrou algum problema ou tem uma ideia para melhorar este
            conteúdo? Envie uma mensagem para a equipe responsável.
          </p>
          ...
          >
            ...
            <textarea
              ...
              placeholder="Digite sua sugestão, dúvida ou relato..."
            />
            ...
            <label htmlFor="suggestion-contact">
              E-mail ou contato <small>(opcional)</small>
            </label>
            ...
            <input
              ...
              type="text"
              maxLength={160}
              value={suggestionForm.userContact}
              onChange={(event) =>
                setSuggestionForm((current) => ({
                  ...current,
              ...
              placeholder="Se quiser receber um retorno"
            />
